...
def dflux_output(jshape,pipe_D,nweld,cent,wp_dim_w,wp_dim_h,wp_P,wp_TS,wp_eff,length):
    ...
    dfluxfile.write('             ' + '\n')
    dfluxfile.write('      call heat_line_input(k,nwps,jshape,rad,power,speed,eff,thold, ' + '\n')
...
step_Creat = step_output(jshape,pipe_D,nweld,wp_TS,length)
#--------------------------------------------------------
